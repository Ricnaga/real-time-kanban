...
function StatisticsErrorFallback({ error, resetErrorBoundary }: FallbackProps) {
  return (
    <div className="flex flex-1 items-center justify-center">
      <div className="text-center">
        <Heading as="h2">Erro ao carregar estatisticas</Heading>
...
export default function StatisticsError({
  ...
  return (
    <ErrorBoundary
      FallbackComponent={StatisticsErrorFallback}
      onReset={reset}
